...
<head>
    ...
    <title>UnResolved Cases - VSafe</title>
        ...
        <div class="content">
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="casebox bg-light text-center rounded p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <h6 class="mb-0">UnResolved Cases</h6>
                    </div>
                    <div class="table-responsive">
                        <table class="table text-start align-middle table-bordered table-hover mb-0">
                            ...
                            <tbody id="link-wrapper-UnResolvedCases">
                                <?php include 'unresolvedcases1.php' ?>
            ...
            <script>
                    ...
                    xhttp.onreadystatechange = function() {
                        ...
                        document.getElementById("link-wrapper-UnResolvedCases").innerHTML = this.responseText;
                        }
                    };
                    xhttp.open("GET", "unresolvedcases1.php", true);
                    xhttp.send();
                    }

...
//Quary to get all unresolved cases
$sql = "SELECT * FROM tbl_case WHERE status = '0' AND DATE(date_time) = CURDATE()";
//Execute quary
...
if ($res == true) {
    ...
    //To show the count in dashboard banner
    $_SESSION['UnResCount'] = $count;

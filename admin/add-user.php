...
<body>
    ...
    <div class="container-xxl position-relative bg-none d-flex p-0">
        ...
        <div class="sidebar pe-4 pb-3">
            ...
            <nav class="navbar navbar-light">
                    ...
                    <a href="users.php" class="nav-item nav-link active"><i class="fa fa-user me-2"></i>Department Users</a>
                </div>
            </nav>
        </div>
        <!-- Sidebar End -->
        ...
        <div class="content">
            ...
            <div class="container-fluid pt-4 px-4">
                ...
                <form method="POST">
                    <div style="padding-top: 40px;"><h5><b>Add User</b></h5></div>
                    <?php
                    ...
                    <div class="row justify-content-center">
                        <div class="col-12 col-sm-8 col-md-6 col-lg-5 col-xl-4" style="padding-top: 30px;">
                            <div class="addusr form-floating mb-3">
                                <input id="depid" name="depid" type="text" class="form-control" id="floatingInput" placeholder="dipId">
                                <label class="txt" for="floatingInput">Department Id</label>
                            </div>
                            <div class="addusr form-floating mb-4">
                                <input id="depname" name="depname" type="text" class="form-control" id="floatingInput" placeholder="dipName">
                                <label class="txt" for="floatingInput">Department Name</label>
                            </div>
                            <div class="addusr form-floating mb-4">
                                <input id="username" name="username" type="text" class="form-control" id="floatingInput" placeholder="uName">
                                <label class="txt" for="floatingInput">User Name</label>
                            </div>
                            <div class="addusr form-floating mb-4">
                                <input id="pwrd" name="pwrd" type="password" class="form-control" id="floatingPassword" placeholder="Password">
                                <label class="txt" for="floatingPassword">Password</label>
                            </div>
                        </div>
                    </div>
                    <div class="nadd row">
                        <input type="Submit" id="btnAdd" name="btnAdd" class="btn addbutton" data-bs-toggle="modal" data-bs-target="#exampleModal" value="Add">
                    </div>
                    ...
                    <?php
                            if(isset($_POST['btnAdd']))
                            {
                                ...
                                $qryAdd ="INSERT INTO tbl_department VALUES('$depid','$user_name','$password','$depname')";
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <button id="btnAdd" name="btnAdd" type="button" class="btn btn-secondary" data-bs-dismiss="modal">Yes</button>
        ...
        <script>
            ...
            xhttp.onreadystatechange = function() {
                ...
                document.getElementById("link-wrapper-cases").innerHTML = this.responseText;
                }
            };
            xhttp.open("GET", "add-user.php", true);
            xhttp.send();
            }

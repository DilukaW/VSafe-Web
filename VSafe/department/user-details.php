...
<head>
    ...
    <title>User Details - VSafe</title>
                    ...
                    <div class="col-md-6">
                        <div class="bg-light text-center rounded p-4">
                            <div class="d-flex align-items-center justify-content-between mb-4" style="text-align: center;">
                                <h6 class="username mb-0"><b><?php echo $department ?></b></h6>
                            </div>
                            <div class="col-md-2">
                    ...
                    <div class="col-md-6">
                        <div class="bg-light text-center rounded p-4">
                            <div class="row case-details">
                                <div class="col-md-5">Department ID</div>
                                <div class="col-md-7">: <span> <?php echo $depid ?> </span> </div>
                           </div>

                           <div class="row case-details">
                                <div class="col-md-5">Department Name</div>
                                <div class="col-md-7">: <span> <?php echo $department ?> </span></div>
                           </div>

                           <div class="row case-details">
                                <div class="col-md-5">User Name</div>
                                <div class="col-md-7">: <span> <?php echo $user ?> </span></div>
                           </div>
                        </div>
                    </div>
                </div>

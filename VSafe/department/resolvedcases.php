...
<head>
    ...
    <title>Resolved Cases - VSafe</title>
        ...
        <div class="content">
                ...
                <div class="casebox bg-light text-center rounded p-4">
                    ...
                    <div class="table-responsive">
                        <table class="table text-start align-middle table-bordered table-hover mb-0">
                            ...
                            <tbody id="link-wrapper-ResolvedCases">
                                <?php include 'resolvedcases1.php' ?>
            ...
            <script>
                    ...
                    xhttp.onreadystatechange = function() {
                        ...
                        document.getElementById("link-wrapper-ResolvedCases").innerHTML = this.responseText;
                        }
                    };
                    xhttp.open("GET", "resolvedcases1.php", true);
                    xhttp.send();
                    }
